...
def _echiquiers_columns() -> dict[str, Column]:
    ...
    return {
        ...
        "ronde": Column(int, checks=[Check.ge(1), Check.le(20)], nullable=False),
        "echiquier": Column(int, checks=[Check.ge(1), Check.le(20)], nullable=False),
        ...
        "resultat_blanc": Column(float, checks=Check.isin([0.0, 0.5, 1.0, 2.0]), nullable=False),
        "resultat_noir": Column(float, checks=Check.isin([0.0, 0.5, 1.0, 2.0]), nullable=False),
