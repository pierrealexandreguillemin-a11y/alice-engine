...
class TestExtractAllFeatures:
    ...
    def test_feature_count_without_advanced(
        ...
        """Test nombre de features sans avancees >= 13 (base + ALI + composition)."""
        result = extract_all_features(sample_history, sample_history_played, include_advanced=False)
    ...
    def test_feature_count_with_advanced(
        ...
        """Test nombre de features avec avancees > sans avancees."""
        base = extract_all_features(sample_history, sample_history_played, include_advanced=False)
        full = extract_all_features(sample_history, sample_history_played, include_advanced=True)
